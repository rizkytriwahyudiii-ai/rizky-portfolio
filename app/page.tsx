...
import { Zap, Code2, ArrowUpRight, Mail } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#050505] text-slate-200 font-sans antialiased selection:bg-amber-500 selection:text-black">
      ...
      <main className="relative min-h-screen flex flex-col items-center justify-center px-6 py-24">
        <div className="max-w-3xl w-full text-center space-y-10">
          ...
          <a href="mailto:rizkytriwahyudiii@gmail.com" className="inline-flex items-center gap-2 text-xs text-slate-600 hover:text-slate-400 transition-colors pt-6">
            <Mail size={13} />
